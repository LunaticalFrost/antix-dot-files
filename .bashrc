...
alias chrome='exec ~/Загрузки/Google-Chrome-stable-150.0.7871.186-1-x86_64.AppImage &>/dev/null & disown'
alias install='sudo apt install'
alias remove='sudo apt purge --autoremove'
alias ftp='filezilla &>/dev/null & disown'
alias commands='cat ~/.bashrc | grep alias'
alias i3cfg='nano ~/.conifg/i3/config'
alias i3barcfg='sudo nano /etc/i3status.conf'
alias bootmenu='sudo nano /mnt/usb0/boot/grub/grub.cfg'
alias del='rm -rfv'
alias cls='clear'
alias reload='source ~/.bashrc; exec bash && echo Reload completed.'
alias search='apt search'
alias shutdown='clear; echo Goodbye...; sleep 3; sudo /usr/sbin/halt'
